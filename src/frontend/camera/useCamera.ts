// Stub for Caffeine platform camera module
...
export function useCamera(config?: CameraConfig): UseCameraReturn {
  ...
  return { isActive, isSupported, error, isLoading, currentFacingMode: facingMode, startCamera, stopCamera, capturePhoto, switchCamera, retry, videoRef, canvasRef };
}

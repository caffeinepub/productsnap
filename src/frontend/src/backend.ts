...
export class Backend implements backendInterface {
    ...
    async createEntry(arg0: string, arg1: string, arg2: string, arg3: string): Promise<ProductEntry> {
        if (this.processError) {
            try {
    ...
    async getAllEntries(): Promise<Array<ProductEntry>> {
        if (this.processError) {
            try {
    ...
    async getEntry(arg0: bigint): Promise<ProductEntry> {
        if (this.processError) {
            try {
    ...
    async searchImages(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateEntry(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string): Promise<ProductEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEntry(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
